...
fn setup(mut cmd: Commands, server: Res<AssetServer>) {
    ...
    cmd.spawn((
        AseTexture::baked(server.load("animated_layers.aseprite"))
    ...
    cmd.spawn((
        AseTexture::baked(server.load("animated_layers.aseprite")).sprite(),
        AseAnimation::default(),
    ...
    // Layer 1 only
    cmd.spawn((
        AseTexture::new(server.load("animated_layers.aseprite"))
            .with_layers(LayerFilter::Include(vec![LayerId::new("Layer 1")]))
            .sprite(),
        AseAnimation::default(),
    ...
    cmd.spawn((
        AseTexture::new(server.load("animated_layers.aseprite")).sprite(),
        AseAnimation::default(),
